...
var PortableTextEditable = /*#__PURE__*/(0, _react.forwardRef)(function PortableTextEditable(props, forwardedRef) {
  ...
  (0, _react.useMemo)(() => (0, _slateReact.withReact)(withEditableAPI(withInsertData(withHotKeys(slateEditor)))), [slateEditor, withEditableAPI, withHotKeys, withInsertData]); // Track selection (action) state
